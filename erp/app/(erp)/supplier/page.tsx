...
//             <div className="w-full h-full flex justify-center items-center  bg-gray-200 p-5">
...
export default function Supplier() {
    ...
    return (
        <div className="h-auto p-4 md:p-5">
            <div className="w-full h-full flex justify-center items-center bg-gray-200">
                <div className="bg-white w-full max-w-3xl p-6 rounded-md shadow-md">
                    {/* Header Section */}
                    {!addForm && !editingSupplier && (
                        <Fragment>
                            <div className="w-full flex justify-between items-center mb-6">
                                <h1 className="text-xl md:text-2xl font-semibold">Supplier</h1>
                                <button
                                    hidden={addForm}
                                    onClick={() => setAddForm(true)}
                                    className="bg-green-400 h-[40px] w-[150px] rounded-md text-gray-900 hover:text-gray-100 cursor-pointer shadow-md"
                                >
                                    Add Supplier
                                </button>
                            </div>
