    ...
    return (
        <div className="pt-10">
            ...
            <form onSubmit={handleSubmit}>
                <div className="w-full h-auto">
                    <div className="w-full h-full flex justify-center items-center bg-gray-200">
                        <div className="bg-white w-[400px] sm:w-[600px] md:w-[800px] h-full flex justify-center items-start flex-col md:rounded-md md:shadow-md">
                            <div className="w-full h-full flex justify-center items-center flex-col pt-10">
                                <div className="w-full h-[40px] flex flex-row p-10">
                                    <label className="pl-2 text-gray-700 w-[150px]">Name</label>
                                    <input className="w-full sm:w-[400px] h-[40px] p-1 outline-none border border-slate-400 rounded-md"
                                        type="text"
                                        name="name"
                                        value={name}
                                        onChange={(e) => setName(e.target.value)}
                                ...
                                <div className="w-full h-[40px] flex flex-row p-10">
                                    ...
                                    <div className="flex flex-col w-full sm:w-[400px]">
                                        <input className={`w-full h-[40px] p-1 outline-none border rounded-md ${errors.email ? 'border-red-500' : 'border-slate-400'}`}
                                            type="email"
                                            name="email"
                                            value={email}
                                            onChange={(e) => setEmail(e.target.value)}
                                ...
                                <div className="w-full h-[40px] flex flex-row p-10">
                                    <label className="pl-2 text-gray-700 w-[150px]">Phone</label>
                                    <div className="flex flex-col w-full sm:w-[400px]">
                                        <input className={`w-full h-[40px] p-1 outline-none border rounded-md ${errors.phone ? 'border-red-500' : 'border-slate-400'}`}
                                            type="tel"
                                            name="phone"
                                            value={phone}
                                            onChange={(e) => setPhone(e.target.value)}
                                ...
                                <div className="w-full h-[40px] flex gap-3 justify-start items-center p-14">
                                    <button className="bg-green-400 w-full sm:w-[150px] h-[50px] rounded-md text-gray-900 hover:text-gray-100 cursor-pointer shadow-md"
                                        type="submit">
                                        Update
                                    </button>
                                    <button className="bg-red-400 w-full sm:w-[150px] h-[50px] rounded-md text-gray-900 hover:text-gray-100 cursor-pointer shadow-md"
                                        type="button" onClick={() => setEditingSupplier(null)}>
                                        Cancel
                                    </button>
                                </div>
