...
export default function Inventory() {
    ...
    return (
        <div className="h-auto m-5">
            <div className="w-full h-full flex justify-center items-center bg-gray-200 p-5">
                <div className="bg-white w-full max-w-4xl h-full flex flex-col justify-start items-start rounded-md shadow-md md:p-6 p-4">
                    {!editingProduct ? (
                        <Fragment>
                            {/* Header Section */}
                            <div className="w-full flex justify-between items-center border-b pb-4">
                                <h1 className="text-xl md:text-2xl font-semibold pl-2">Product</h1>
                            </div>
